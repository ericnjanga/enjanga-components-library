...
export interface CaseStudyCardProps
  extends Omit<ComponentPropsWithoutRef<'article'>, 'title' | 'children'> {
  ...
  function CaseStudyCard(
    ...
    return (
      <article
        ...
        className={clsx(
          'enj-case-study-card',
          !hasMedia && 'enj-case-study-card--text-only',
          className
        )}
      >
        <CaseStudyMedia
          ...
          videoSrc={videoSrc}
          videoType={videoType}
          onWatchIntro={videoSrc || onWatchIntro ? watchIntro : undefined}
        ...
        <div className="enj-case-study-card__content">
          <h2 id={titleId} className="enj-h2">
            {title}
          </h2>
